      ...
      <q-card flat class="col-grow bg-grey-1">
        ...
        <q-carousel
          ...
          <div class="row fit justify-start items-center q-gutter-xs q-col-gutter no-wrap">
            <q-img fit="fit" class="rounded-borders col-4 full-height" src="src/assets/img/IMG_0300.JPG" />
            <q-img fit="scale-down" class="rounded-borders col-4 full-height" src="https://cdn.quasar.dev/img/parallax1.jpg" />
            <q-img fit="scale-down" class="rounded-borders col-4 full-height" src="src/assets/img/IMG_0300.JPG" />
          </div>
          </q-carousel-slide>
          <q-carousel-slide
            :name="2"
